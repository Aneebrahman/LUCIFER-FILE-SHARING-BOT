class script(object):
    START_TXT = """<b>𝘏𝘦𝘭𝘰 {},    
𝘔𝘺 𝘕𝘢𝘮𝘦 𝘐𝘴 <a href=https://t.me/{}>{}</a>, 𝘐 𝘊𝘢𝘯 𝘗𝘳𝘰𝘷𝘪𝘥𝘦 𝘔𝘰𝘷𝘪𝘦𝘴, 𝘑𝘶𝘴𝘵 𝘈𝘥𝘥 𝘔𝘦 𝘛𝘰 𝘠𝘰𝘶𝘳 𝘎𝘳𝘰𝘶𝘱 𝘈𝘯𝘥 𝘔𝘢𝘬𝘦 𝘔𝘦 𝘈𝘥𝘮𝘪𝘯.... 𝘛𝘩𝘦𝘯 𝘚𝘦𝘦 𝘔𝘺 𝘗𝘰𝘸𝘦𝘳𝘴💥💥🔥
<a ✰━━━━━━━━━━━━━━✰</a>
©Mᴀɪɴᴛᴀɪɴᴇᴅ ʙy: <a href=https://t.me/psycho_009>『ƬǤx』×͜× ᴅᴜᴅᴇ 𓄀℡ ️️</a>
</b>"""
    
    HELP_TXT = """<b>Hᴇy {}
Hᴇʀᴇ Iꜱ Tʜᴇ Hᴇʟᴩ Fᴏʀ My Cᴏᴍᴍᴀɴᴅꜱ.</b>"""
...
- Sᴏᴜʀᴄᴇ - Cʟɪᴄᴋ Rᴇᴩᴏ Bᴜᴛᴛᴏɴ</b>
<b>Dᴇᴠꜱ:</b>
- <a href=https://t.me/Ak_Links1>Aᴋ Bᴏᴛꜱ</a>"""

    MANUELFILTER_TXT = """Help: <b>Filters</b>

<b>- Fɪɴᴛᴇʀ Iꜱ Tʜᴇ Fᴇᴀᴛᴜʀᴇ Wᴇʀᴇ Uꜱᴇʀꜱ Cᴀɴ Sᴇᴛ Aᴜᴛᴏᴍᴀᴛᴇᴅ Rᴇᴩʟɪᴇꜱ Fᴏʀ A Pᴀʀᴛɪᴄᴜʀᴀʀ Kᴇyᴡᴏʀᴅ Aɴᴅ Bᴏᴛ Wɪʟʟ Rᴇꜱᴩᴏɴᴅ Wʜᴇɴᴇᴠᴇʀ A Kᴇyᴡᴏʀᴅ Iꜱ Fᴏᴜɴᴅ Tʜᴇ Mᴇꜱꜱᴀɢᴇ</b>

<b>NOTE:</b>
<b>𝟷. 𝙳𝚀 𝟸.𝟶 𝚂𝙷𝙾𝚄𝙻𝙳 𝙷𝙰𝚅𝙴 𝙰𝙳𝙼𝙸𝙽 𝙿𝚁𝙸𝚅𝙸𝙻𝙻𝙰𝙶𝙴.
...
<b>𝙳𝚀 𝟸.𝟶 𝚂𝚄𝙿𝙿𝙾𝚁𝚃𝚂 𝙱𝙾𝚃𝙷 𝚄𝚁𝙻 𝙰𝙽𝙳 𝙰𝙻𝙴𝚁𝚃 𝙸𝙽𝙻𝙸𝙽𝙴 𝙱𝚄𝚃𝚃𝙾𝙽𝚂.</b>
<b>NOTE:</b>
<b>𝟷. 𝚃𝙴𝙻𝙴𝙶𝚁𝙰𝙼 𝚆𝙸𝙻𝙻 𝙽𝙾𝚃 𝙰𝙻𝙻𝙾𝚆𝚂 𝚈𝙾𝚄 𝚃𝙾 𝚂𝙴𝙽𝙳 𝙱𝚄𝚃𝚃𝙾𝙽𝚂 𝚆𝙸𝚃𝙷𝙾𝚄𝚃 𝙰𝙽𝚈 𝙲𝙾𝙽𝚃𝙴𝙽𝚃, 𝚂𝙾 𝙲𝙾𝙽𝚃𝙴𝙽𝚃 𝙸𝚂 𝙼𝙰𝙽𝙳𝙰𝚃𝙾𝚁𝚈.
𝟸. 𝙳𝚀 𝟸.𝟶 𝚂𝚄𝙿𝙿𝙾𝚁𝚃𝚂 𝙱𝚄𝚃𝚃𝙾𝙽𝚂 𝚆𝙸𝚃𝙷 𝙰𝙽𝚈 𝚃𝙴𝙻𝙴𝙶𝚁𝙰𝙼 𝙼𝙴𝙳𝙸𝙰 𝚃𝚈𝙿𝙴.
...
<b>COMMAND</b> : /font your text (optional)
 ...
 <i>This feature added by @AK 𝙱𝙾𝚃𝚉"""
    JSON_TXT = """<b>⚙️ 𝗝𝘀𝗼𝗻
ʙᴏᴛ ʀᴇᴛᴜʀɴs ᴊsᴏɴ ꜰᴏʀ ᴀʟʟ ʀᴇᴘʟɪᴇᴅ ᴍᴇssᴀɢᴇs ᴡɪᴛʜ /json ᴏʀ /js
ꜰᴇᴀᴛᴜʀᴇs:
...
ᴇᴠᴇʀʏᴏɴᴇ ᴄᴀɴ ᴜsᴇ ᴛʜɪs ᴄᴏᴍᴍᴀɴᴅ , ɪꜰ sᴘᴀᴍɪɴɢ ʜᴀᴘᴘᴇɴs ʙᴏᴛ ᴡɪʟʟ ᴀᴜᴛᴏᴍᴀᴛɪᴄᴀʟʟʏ ʙᴀɴ ʏᴏᴜ ꜰʀᴏᴍ ᴛʜᴇ ɢʀᴏᴜᴘ.</b>"""
    ...
    WHOIS_TXT ="""<b>⚙ 𝗪𝗵𝗼𝗶𝘀 𝗠𝗼𝗱𝘂𝗹𝗲
𝐍𝐨𝐭𝐞 :- ɢɪᴠᴇ ᴀ ᴜsᴇʀ ᴅᴇᴛᴀɪʟs

➪/whois :-ɢɪᴠᴇ ᴀ ᴜsᴇʀ ꜰᴜʟʟ ᴅᴇᴛᴀɪʟs 📑</b>"""
...
©Mᴀɪɴᴛᴀɪɴᴇᴅ ʙy: <a href=https://t.me/psycho_009>『ƬǤx』×͜× ᴅᴜᴅᴇ 𓄀℡ ️️</a></b>"""
...
• ᴜꜱᴇʀɴᴀᴍᴇ : @psycho_009
• ᴘᴇʀᴍᴀɴᴇɴᴛ ᴅᴍ ʟɪɴᴋ : <a href=https://t.me/psycho_009>『ƬǤx』×͜× ᴅᴜᴅᴇ 𓄀℡ ️️</a>
</b>"""
...
📢 Bᴏᴛ Uᴘᴅᴀᴛᴇs Cʜᴀɴɴᴇʟ.
    ...
    ALRT_TXT = """𝚃𝙷𝙰𝚃 𝙸𝚂 𝙽𝙾𝚃 𝙵𝙾𝚁 𝚈𝙾𝚄 𝚂𝙸𝚁 @Ak Botz"""

    OLD_ALRT_TXT = """𝐘𝐨𝐮 𝐚𝐫𝐞 𝐮𝐬𝐢𝐧𝐠 𝐨𝐧𝐞 𝐨𝐟 𝐦𝐲 𝐨𝐥𝐝 𝐦𝐞𝐬𝐬𝐚𝐠𝐞𝐬, 𝐩𝐥𝐞𝐚𝐬𝐞 𝐬𝐞𝐧𝐝 𝐭𝐡𝐞 𝐫𝐞𝐪𝐮𝐞𝐬𝐭 𝐚𝐠𝐚𝐢𝐧 @Ak Botz"""
...
➪Aᴋ Mᴏᴠɪᴇꜱ"""
    ...
    I_CUDNT = """Hᴇʟʟᴏ {} I Cᴏᴜᴅɴ'ᴛ Fɪɴᴅ Aɴy Mᴏᴠɪᴇꜱ Iɴ Tʜᴀᴛ Nᴀᴍᴇ @MH_moviesgroup01  ."""

    I_CUD_NT = """Hᴇʟʟᴏ {} I Cᴏᴜᴅɴ'ᴛ Fɪɴᴅ Aɴyᴛʜɪɴɢ Rᴇʟᴀᴛᴇᴅ Tᴏ Tʜᴀᴛ. Cʜᴇᴄᴋ Yᴏᴜʀ Sᴩᴇʟʟɪɴɢ @MH_moviesgroup01."""
    
    CUDNT_FND = """Hᴇʟʟᴏ {} I Cᴏᴜᴅɴ'ᴛ Fɪɴᴅ Aɴyᴛʜɪɴɢ Rᴇʟᴀᴛᴇᴅ Tᴏ Tʜᴀᴛ Dɪᴅ Yᴏᴜ Mᴇᴀɴ Aɴy Oɴᴇ Oꜰ Tʜᴇꜱᴇ? @MH_moviesgroup01"""
    
    REPRT_MSG = """ Reported To Admin"""
    
    ZOMBIES_TXT = """<b>⚙ 𝗞𝗶𝗰𝗸 𝗺𝗼𝗱𝘂𝗹𝗲
𝐍𝐨𝐭𝐞 : ᴋɪᴄᴋ ɪɴᴄᴀᴛɪᴠᴇ ᴍᴇᴍʙᴇʀs ꜰʀᴏᴍ ɢʀᴏᴜᴘ. ᴀᴅᴅ ᴍᴇ ᴀs ᴀᴅᴍɪɴ ᴡɪᴛʜ ʙᴀɴ ᴜsᴇʀs ᴘᴇʀᴍɪssɪᴏɴ ɪɴ ɢʀᴏᴜᴘ.

𝐂𝐨𝐦𝐦𝐚𝐧𝐝𝐬 :
• /inkick - ᴄᴏᴍᴍᴀɴᴅ ᴡɪᴛʜ ʀᴇǫᴜɪʀᴇᴅ ᴀʀɢᴜᴍᴇɴᴛs ᴀɴᴅ ɪ ᴡɪʟʟ ᴋɪᴄᴋ ᴍᴇᴍʙᴇʀs ꜰʀᴏᴍ ɢʀᴏᴜᴘ.
• /instatus - ᴛᴏ ᴄʜᴇᴄᴋ ᴄᴜʀʀᴇɴᴛ sᴛᴀᴛᴜs ᴏꜰ ᴄʜᴀᴛ ᴍᴇᴍʙᴇʀ ꜰʀᴏᴍ ɢʀᴏᴜᴘ.
• /inkick ᴡɪᴛʜɪɴ_ᴍᴏɴᴛʜ ʟᴏɴɢ_ᴛɪᴍᴇ_ᴀɢᴏ - ᴛᴏ ᴋɪᴄᴋ ᴜsᴇʀs ᴡʜᴏ ᴀʀᴇ ᴏꜰꜰʟɪɴᴇ ꜰᴏʀ ᴍᴏʀᴇ ᴛʜᴀɴ 6-7 ᴅᴀʏs.
• /inkick ʟᴏɴɢ_ᴛɪᴍᴇ_ᴀɢᴏ - ᴛᴏ ᴋɪᴄᴋ ᴍᴇᴍʙᴇʀs ᴡʜᴏ ᴀʀᴇ ᴏꜰꜰʟɪɴᴇ ꜰᴏʀ ᴍᴏʀᴇ ᴛʜᴀɴ ᴀ ᴍᴏɴᴛʜ ᴀɴᴅ ᴅᴇʟᴇᴛᴇᴅ ᴀᴄᴄᴏᴜɴᴛs.
• /dkick - ᴛᴏ ᴋɪᴄᴋ ᴅᴇʟᴇᴛᴇᴅ ᴀᴄᴄᴏᴜɴᴛs.</b>"""
...
𝙲𝚁𝙴𝙳𝙸𝚃𝚂 ›› <a href=https://t.me/psycho_009><b>『ƬǤ』×͜×ʟᴇɢᴇɴᴅ𓄀℡ ️️</b></a>"""
